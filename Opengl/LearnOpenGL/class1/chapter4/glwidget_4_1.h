#ifndef GLWIDGET_4_1_H
#define GLWIDGET_4_1_H
...
class GLWidget_4_1 : public QOpenGLWidget, protected QOpenGLFunctions_4_5_Core
{
    Q_OBJECT
...
public:
    explicit GLWidget_4_1(QWidget *parent = nullptr);
