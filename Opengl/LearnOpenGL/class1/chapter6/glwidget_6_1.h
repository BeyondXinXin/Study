#ifndef GLWIDGET_6_1_H
#define GLWIDGET_6_1_H
...
class GLWidget_6_1 : public QOpenGLWidget, protected QOpenGLFunctions_4_5_Core
{
    Q_OBJECT
...
public:
    explicit GLWidget_6_1(QWidget *parent = nullptr);
