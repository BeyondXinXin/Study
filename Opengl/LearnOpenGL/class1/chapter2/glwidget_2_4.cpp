...
GLWidget_2_4::GLWidget_2_4(QWidget *parent)
...
void GLWidget_2_4::initializeGL()
{
...
void GLWidget_2_4::resizeGL(int w, int h)
{
    Q_UNUSED(w)
    Q_UNUSED(h)
}

void GLWidget_2_4::paintGL()
{
...
void GLWidget_2_4::SetShape(const GLWidget_2_4::Shape &shape)
{
    shape_ = shape;
    update();
}

void GLWidget_2_4::SetWireFrame(const bool &shape)
{
    makeCurrent();
    if (shape) {
        // 线框填充方式
