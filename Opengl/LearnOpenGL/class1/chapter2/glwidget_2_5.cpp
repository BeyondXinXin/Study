...
GLWidget_2_5::GLWidget_2_5(QWidget *parent)
  : QOpenGLWidget(parent)
{
    ...
    connect(&timer, &QTimer::timeout, this, &GLWidget_2_5::ColorAutoChange);
}

void GLWidget_2_5::initializeGL()
{
...
void GLWidget_2_5::resizeGL(int w, int h)
{
    Q_UNUSED(w)
    Q_UNUSED(h)
}

void GLWidget_2_5::paintGL()
{
...
void GLWidget_2_5::showEvent(QShowEvent *event)
{
    timer.start(100);
    QOpenGLWidget::showEvent(event);
}

void GLWidget_2_5::SetShape(const GLWidget_2_5::Shape &shape)
{
    shape_ = shape;
    update();
}

void GLWidget_2_5::SetWireFrame(const bool &shape)
{
    makeCurrent();
    if (shape) {
        // 线框填充方式
...
void GLWidget_2_5::ColorAutoChange()
{
    if (shape_ == NoShape) {
        return;
    }
