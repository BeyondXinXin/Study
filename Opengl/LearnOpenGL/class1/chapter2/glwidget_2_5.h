#ifndef GLWIDGET_2_5_H
#define GLWIDGET_2_5_H
...
class GLWidget_2_5 : public QOpenGLWidget, protected QOpenGLFunctions_4_5_Core
{
    Q_OBJECT
...
public:
    explicit GLWidget_2_5(QWidget *parent = nullptr);
