#ifndef GLWIDGET_2_4_H
#define GLWIDGET_2_4_H
...
class GLWidget_2_4 : public QOpenGLWidget, protected QOpenGLFunctions_4_5_Core
{
    Q_OBJECT
...
public:
    explicit GLWidget_2_4(QWidget *parent = nullptr);
