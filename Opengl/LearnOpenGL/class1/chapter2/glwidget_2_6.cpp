...
void GLWidget_2_6::initializeGL()
{
...
void GLWidget_2_6::SetShape(const GLWidget_2_6::Shape &shape)
{
    shape_ = shape;
    update();
}

void GLWidget_2_6::SetWireFrame(const bool &shape)
{
    makeCurrent();
    if (shape) {
        // 线框填充方式
