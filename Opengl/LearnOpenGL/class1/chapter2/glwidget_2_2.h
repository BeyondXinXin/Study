#ifndef GLWIDGET_2_2_H
#define GLWIDGET_2_2_H
...
class GLWidget_2_2 : public QOpenGLWidget, protected QOpenGLFunctions_4_5_Core
{
    Q_OBJECT
...
public:
    explicit GLWidget_2_2(QWidget *parent = nullptr);
