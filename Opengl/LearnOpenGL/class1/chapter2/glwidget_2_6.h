#ifndef GLWIDGET_2_6_H
#define GLWIDGET_2_6_H
...
class GLWidget_2_6 : public QOpenGLWidget, protected QOpenGLFunctions_4_5_Core
{
    Q_OBJECT
...
public:
    explicit GLWidget_2_6(QWidget *parent = nullptr);
