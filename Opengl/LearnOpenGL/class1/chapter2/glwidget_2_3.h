#ifndef GLWIDGET_2_3_H
#define GLWIDGET_2_3_H
...
class GLWidget_2_3 : public QOpenGLWidget, protected QOpenGLFunctions_4_5_Core
{
    Q_OBJECT
...
public:
    explicit GLWidget_2_3(QWidget *parent = nullptr);
