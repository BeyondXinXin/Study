#ifndef GLWIDGET_3_6_H
#define GLWIDGET_3_6_H
...
class GLWidget_3_6 : public QOpenGLWidget, protected QOpenGLFunctions_4_5_Core
{
    Q_OBJECT
...
public:
    explicit GLWidget_3_6(QWidget *parent = nullptr);
