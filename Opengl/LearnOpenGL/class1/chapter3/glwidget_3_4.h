#ifndef GLWIDGET_3_4_H
#define GLWIDGET_3_4_H
...
class GLWidget_3_4 : public QOpenGLWidget, protected QOpenGLFunctions_4_5_Core
{
    Q_OBJECT
...
public:
    explicit GLWidget_3_4(QWidget *parent = nullptr);
