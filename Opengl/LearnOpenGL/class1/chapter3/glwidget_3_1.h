#ifndef GLWIDGET_3_1_H
#define GLWIDGET_3_1_H
...
class GLWidget_3_1 : public QOpenGLWidget, protected QOpenGLFunctions_4_5_Core
{
    Q_OBJECT
...
public:
    explicit GLWidget_3_1(QWidget *parent = nullptr);
