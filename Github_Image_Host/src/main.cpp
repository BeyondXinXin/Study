...
//const QString token = "token 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";
...
int mai11n(int argc, char *argv[])
{
    ...
    token = "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";
...
//token = "token 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";
//userName = "BeyondXinXin";
//repoName = "BeyondXinXIn";
